...
public class Set extends BinaryOperation implements Operand {
    public Set(Operand operand1, Operand operand2) {
        super(operand1, operand2);
    }
    @Override
    public String toString() {
        return "(" + operand1.toString() + " " + "set" + " " + operand2.toString() + ")";
    }
...
//        if (binary.length() < operand2.getValue() + 1) {
//            binary = "0".repeat(operand2.getValue() - binary.length() + 1) + binary;
//        }
//
//        char ch = '1';
